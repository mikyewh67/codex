...
function renderDashboard() {
 ...
 <div class="dashboard-columns">
  <section><div class="section-heading"><h2>Find your flow</h2><span class="eyebrow">LET’S GET INTO IT</span></div>
   <div class="mode-grid">
    ...
    <button class="mode-card" id="openFourDayCoach"><span class="mode-icon">${icon('spark')}</span><span class="mode-arrow">${icon('arrow')}</span><strong>Ledger Academy</strong><small>Guided lessons, adaptive practice + audio.</small></button>
   </div>
 ...
 app.querySelector('#openFourDayCoach').onclick=()=>{ window.location.href='mastery.html'; };
